...
function CreateQuizPage() {
  ...
  useEffect(() => {
    if (touchedFields.questions.length !== formData.questions.length) {
      setTouchedFields((prev) => ({
        ...prev,
        questions: Array(formData.questions.length)
          .fill(null)
          .map((_, i) => ({
  ...
  const validateStep2 = () => {
    ...
    return !questionErrors.some(
      (q) => q.question || q.options.some((optErr) => optErr)
    );
  };
    ...
    if (field === "answer") {
      setTouchedFields((prev) => {
        ...
        if (
          ...
          updatedTouched[questionIndex].options
        ) {
      ...
      setFormErrors((prev) => {
        ...
        if (
          ...
          updatedQuestionErrors[questionIndex].options
        ) {
          const updatedOptionErrors = [
            ...updatedQuestionErrors[questionIndex].options,
          ];
  ...
  const shouldShowError = (
    ...
    if (step === 1) {
      ...
      if (fieldType === "question") {
        return (
          touchedFields.questions[questionIndex]?.question &&
          formErrors.step2.questions[questionIndex]?.question
        );
      } else if (fieldType === "option") {
        return (
          touchedFields.questions[questionIndex]?.options[optionIndex] &&
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center py-4 px-8">
        ...
        <img src="/ramen.png" alt="Logo" className="w-16 h-16" />
      </div>
                ...
                >
                  ...
                  <div>
                    <DarkThemeInput
                      ...
                      value={formData.quiz}
                      onChange={(e) =>
                        handleInputChange("quiz", e.target.value)
                      }
                  ...
                  <div>
                    <DarkThemeInput
                      ...
                      onChange={(e) =>
                        handleInputChange("adminUsername", e.target.value)
                      }
                      placeholder="Enter admin username"
                      className={
                        formErrors.step1.adminUsername ? "border-red-500" : ""
                      }
                    />
                  ...
                  <div>
                    <DarkThemeInput
                      ...
                      className={
                        formErrors.step1.adminPassword ? "border-red-500" : ""
                      }
                    />
                  ...
                  {/* <div>
                    <DarkThemeInput
                      label={
                        <>
                          Active Until <span className="text-red-400">*</span>
                        </>
                      }
                      name="active-until"
                      type="datetime-local"
                      ...
                      className={
                        formErrors.step1.activeUntil ? "border-red-500" : ""
                      }
                    />
                    ...
                    <DarkThemeQuestionCard key={index}>
                      ...
                      <div className="flex items-center space-x-6 mt-4">
                        ...
                        <DarkThemeCheckbox
                          ...
                          onChange={(e) =>
                            updateQuestion(index, "bonus", e.target.checked)
                          }
                        />
                      </div>
                        ...
                        {question.options.map((option, optIndex) => (
                          ...
                          >
                            ...
                            <DarkThemeRadio
                              ...
                              onChange={() =>
                                updateOption(index, optIndex, "isCorrect", true)
                              }
